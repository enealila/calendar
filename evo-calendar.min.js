  ...
  ((t = (function () {
    ...
    return function (a, n) {
          ...
          (i.initials = {
            ...
            dates: {
              ...
              sq: {
                ...
                noEventForToday: "Nuk ka asnjë çeshtje për shqyrtim!",
                noEventForThisDay: "Nuk ka asnjë çeshtje për shqyrtim!",
              },
            },
          }),
          (i.initials.weekends = {
      ...
      (i.startingDay = null),
        ...
        (i.$current = {
          ...
          year:
            isNaN(this.year) || null == this.year
              ...
              : this.year,
          date: i.formatDate(
            i.initials.dates["en"].months[new Date().getMonth()] +
            " " +
            new Date().getDate() +
            " " +
            new Date().getFullYear(),
        ...
        (i.$label = {
          days: [],
          months: i.initials.dates["en"].months,
    ...
    (t.prototype.limitTitle = function (e, t) {
      var a = [];
      if (((t = void 0 === t ? 118 : t), e.split(" ").join("").length > t)) {
    ...
    (t.prototype.formatDate = function (t, a, n) {
      ...
      (l.dd = (l.d < 10 ? "0" : "") + l.d),
        ...
        (t = []);
      for (
        var s = e.extend([], a.separators), r = 0, d = a.parts.length;
        r <= d;
        r++
      )
    ...
    (t.prototype.hasSameDayEventType = function (e, t) {
      for (var a = this, n = 0, i = 0; i < a.options.calendarEvents.length; i++)
        if (a.options.calendarEvents[i].date instanceof Array)
          for (
            var o = a.getBetweenDates(a.options.calendarEvents[i].date), l = 0;
            l < o.length;
            l++
          )
      ...
      if ((i.children().length > 0 && i.empty(), t.options.calendarEvents))
        for (var o = 0; o < t.options.calendarEvents.length; o++)
          if (
            ...
            new Date(t.$active.date.getMonth() + 1) +
              " " +
              new Date(t.$active.date).getDate() ==
              new Date(t.options.calendarEvents[o].date.getMonth() + 1) +
              " " +
      ...
      a ||
        ((e = '<div class="event-empty">'),
          t.$active.date === t.$current.date
            ? (e += `<p>${t.initials.dates[t.options.language].noEventForToday
              }</p>`)
            : (e += `<p>${t.initials.dates[t.options.language].noEventForThisDay
              }</p>`),
          (e += "</div>")),
        i.append(e);
    }),
    ...
    (t.prototype.buildCalendar = function () {
      ...
      a.calculateDays(),
        (t = a.formatDate(
          new Date(a.$active.month + 1 + "/01/" + a.$active.year),
